    ...
    >
      <header className={styles.headerContainer}>
        <Link
          href="#"
          id="logo"
          className={classNames(styles.log, styles.logoContainer)}
        >
          <img
            src="assets/cheddar-logo-reduced.png"
            className={styles.headerCheddarIcon}
          />
          <div className={classNames(styles.textWhite, styles.logoText)}>
            Cheddar Maze
          </div>
        </Link>
        ...
        <div className={styles.flexAlignCenter}>
          <div className={styles.musicIcon} onClick={onOpenVideoModal}>
            🎶
          </div>
          ...
          {selector.isSignedIn() ? (
            ...
            >
              ...
              <div>
                <span className={classNames(styles.userName, styles.textWhite)}>
                  {smartTrim(accountId ?? '', 10)}
                </span>
              </div>
            </div>
          ) : (
            <div className={styles.marginLeftSm}>
              <Button onClick={modal.show} size="sm">
                Login
              </Button>
            </div>
          )}
